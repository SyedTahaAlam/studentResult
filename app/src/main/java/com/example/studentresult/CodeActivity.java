...
public class CodeActivity extends AppCompatActivity {
                ...
                if (getIntent() != null) {
                    ...
                    switch (bundle.getInt("type")) {
                        case 1:
                            ...
                            checkCode((com.example.studentresult.Model.Diploma.Datum) bundle.getSerializable("bodydata"));

                            Log.e("certificate", bundle.getSerializable("bodydata").toString());
                            break;
                        case 2:

                            checkCode((com.example.studentresult.Model.HigherDiploma.Datum) bundle.getSerializable("bodydata"));
    ...
    private void checkCode(com.example.studentresult.Model.HigherDiploma.Datum bodydata) {
    ...
    private void checkCode(com.example.studentresult.Model.Diploma.Datum bodydata) {
        if (bodydata.getSecretCode().equalsIgnoreCase(codestr)) {
            Bundle bundle = new Bundle();
            bundle.putSerializable("bodydata", bodydata);
